...
> Этот репозиторий — часть систематизации моей экспертизы. Здесь будут публиковаться шаблоны, методики и архитектурные паттерны для **суверенных, аудитуемых и compliance-ready AI-автоматизаций**.
