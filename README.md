...
> 🔒 Все non-Russian модели — **локально, без интернета, на VPS в РФ**, с предварительной обезличкой и аудитом метаданных.  
> ⚠️ **Не использую**: OpenAI, Anthropic, Google Gemini, Claude — из соображений ИБ и лицензирования.
